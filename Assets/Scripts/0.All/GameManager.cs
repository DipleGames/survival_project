...
public class GameManager : Singleton<GameManager>
{
    ...
    public string[] statNames = { "ÏµúÎ Ï≤¥Î†•", "Í≥µÍ≤©, "Í∑ºÍ±∞Î¶Í≥µÍ≤©, "êÍ±∞Î¶Í≥µÍ≤©, "åÎ≥µ òÏπò", "Î∞©Ïñ¥, "Í≥µÍ≤© çÎèÑ", "¥Îèô çÎèÑ", "¨Î¶¨∞Ïª¨", "åÌîº };
    ...
    /// <summary> ÑÏù¥id - ïÎ≥¥</summary>
    public Dictionary<int, Item> Items = new Dictionary<int, Item>();
    /// <summary> ÑÏù¥id - Í∞àò </summary>
    ...
    {
        {Acquisition.CraftTable, "úÏûëÄ"}, {Acquisition.Logging, "Î≤åÎ™©"}, {Acquisition.Fishing, "öÏãú"},
        {Acquisition.Bush, "Ï±ÑÏßë" }, {Acquisition.FishPot, "µÎ∞ú"}, {Acquisition.CampFire, "Î™®Îã•Î∂},
        {Acquisition.Item, "ÑÏù¥¨Ïö©" }
    };
